export const playerTotalPresence = [
  { name: 'Viac', presenze: 98 },
  { name: 'Rose', presenze: 94 },
  { name: 'Forn', presenze: 90 },
  { name: 'Ale', presenze: 82 },
  { name: 'Olly', presenze: 44 },
  { name: 'Melissa', presenze: 44 },
  { name: 'Nixon', presenze: 36 },
  { name: 'Scar', presenze: 2 },
];
...
export const playedGames = [
  ...
  { name: 'Return to Moria', giocate: 5 },
...
export const weeklyPresence = [
  ...
  '01/04/2026','08/04/2026','15/04/2026',
].map((date, i) => ({
  date,
  presenze: [
    ...
    6,4,3,4,3,3,6,5,5,6,4,5,3,5,4,4,3,5,4,4,4,4,5,4,4,6,5,
  ][i],
}));
